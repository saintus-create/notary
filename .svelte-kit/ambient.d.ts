...
declare module '$env/static/private' {
	...
	export const BEDROCK_PROJECT: string;
	export const npm_package_engines_node: string;
	export const GPG_KEY: string;
	export const BEDROCK_APP: string;
	...
	export const INSTANCE_IP: string;
	...
	export const POD_NAMESPACE: string;
